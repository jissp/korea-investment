...
import { DomesticStockQuotationInquireIndexPriceOutput } from '@modules/korea-investment/korea-investment-quotation-client';

class DomesticIndexPrice implements DomesticStockQuotationInquireIndexPriceOutput {
    @ApiProperty({
...
export class DomesticIndexPriceWithKey {
    @ApiProperty({
        type: String,
    })
    key: string;
...
export class DomesticIndexPriceResponse {
    @ApiProperty({
        type: DomesticIndexPriceWithKey,
        isArray: true,
    })
    data: DomesticIndexPriceWithKey[];
}
